...
<fs-suggestion>
  ...
  <div class="fs-suggestion__field">
    ...
    <p class="fs-suggestion__empty" hidden data-preserve-attr="hidden">Ingen treff</p>
      ...
      return (
        <fs-suggestion>
          ...
          <div {...forslag.field}>
            ...
            <p className="fs-suggestion__empty" hidden data-preserve-attr="hidden">Ingen treff</p>
            <span {...forslag.status} />
          </div>
        </fs-suggestion>
      )
