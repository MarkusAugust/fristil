...
<Tabs>
  ...
  <TabItem label="Ren HTML">
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fristil/designsystem@0.15.0/src/components/ramme/popover/popover.css">
    ...
    <script type="module">
      import { defineFsPopover } from
        "https://cdn.jsdelivr.net/npm/@fristil/designsystem@0.15.0/dist/components/ramme/popover/fs-popover.js"
