...
Finner komponenten ikke delene sine, sier den fra i konsollen. Et `<fs-field>` uten en kontroll eller uten en `<label>` gir en advarsel med navnet på det som mangler, framfor et felt som stilltiende står uten kobling.
