...
Det er alt du trenger å installere. `lit` følger med, og brukes av ramme- og frittstående komponenter. Bruker du bare CSS-komponentene, havner Lit aldri i bunten din, siden ingenting registreres ved import alene. Tailwind-temaet er ren CSS, så pakken krever ingenting av Tailwind.
