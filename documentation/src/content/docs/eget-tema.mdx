...
Blokknavnene kan stå på norsk eller engelsk, som fargene. Nøklene inni er engelske, og de står i tabellen under.
...
| Nøkkel | Treffer |
| --- | --- |
| `buttonRadius` | knappen, paginering og hopplenken |
| `fieldRadius` | feltet, tekstområdet og nedtrekkslista |
| `surfaceRadius` | kort, dialog, sprettoppvindu, varsel, trekkspill, feiloppsummering, filopplasting, økttidsavbrudd, forslagslista, meldingen og hjelpeboblen |
...
Avkryssingsboksen, radioknappen, merket, etiketten, valggruppa, avataren og skjelettet står utenfor. Der er hjørnet ikke et stilvalg, men selve formen: en avkryssingsboks som blir rund, ser ut som en radioknapp, og et merke som blir firkantet, ser ut som en knapp.
