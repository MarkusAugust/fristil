...
| `--font-weight-medium` | 500 | knapp |
| `--font-weight-semibold` | 600 | korttittel, varsel, trekkspill |
| `--font-weight-bold` | 700 | overskrift |
| `--semantic-line-height-default` | 1.5 | knapp, felt, tabellcelle |
| `--semantic-line-height-heading` | 1.2 | overskrift |
| `--semantic-line-height-article` | 1.6 | brødtekst |

Komponentene leser dem gjennom sin egen variabel, slik at et tema kan endre alle knapper uten å endre all tekst: `font-weight: var(--fs-button-font-weight, var(--font-weight-medium))`.
