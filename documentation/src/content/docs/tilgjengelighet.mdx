...
| [Toggle Group](../components/toggle-group/), [Tag](../components/tag/), [Pagination](../components/pagination/), [Tabs](../components/tabs/) | Viser det valgte med `Highlight` og `HighlightText` |
...
| [Dialog](../components/dialog/), [Popover](../components/popover/), [Toast](../components/toast/), [Session Timeout](../components/session-timeout/) | Bredden er begrenset av skjermen, ikke bare av en fast verdi |
