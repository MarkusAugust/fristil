...
<Tabs>
  ...
  <TabItem label="Ren HTML">
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fristil/designsystem@0.14.0/src/components/frittstaende/connection-status/connection-status.css">
    ```
    ...
    <script type="module">
      import { defineFsConnectionStatus } from
        "https://cdn.jsdelivr.net/npm/@fristil/designsystem@0.14.0/dist/components/frittstaende/connection-status/fs-connection-status.js"
    ...
    <script type="module">
      ...
      if (!samband) throw new Error("fant ikke elementet")
  ...
  <TabItem label="React">
    ```ts
    // src/fristil.d.ts, gir <fs-connection-status> typer i JSX
