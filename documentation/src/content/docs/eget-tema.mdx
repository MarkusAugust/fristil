...
De samme verdiene finnes som flagg: `--skrift`, `--knapp-hjorner`, `--felt-hjorner`, `--flate-hjorner`, `--knapp-ramme` og `--knapp-vekt`. Et flagg som ikke finnes stopper kjøringen framfor å bli ignorert, så en skrivefeil sier fra.
