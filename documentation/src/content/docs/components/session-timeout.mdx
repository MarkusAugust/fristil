...
Derfor setter byggeren `data-ignore-morph`. Det ber Datastar la innholdet være, slik at en patch ikke river dialogen bort mens den står åpen. Se [Server først](/server-forst/) for hele regelen.
