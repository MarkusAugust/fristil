  ...
  <TabItem label="Ren HTML">
    ...
    <script type="module">
      import { defineFsToast } from
        "https://cdn.jsdelivr.net/npm/@fristil/designsystem@0.13.0/dist/components/frittstaende/toast/fs-toast.js"
...
Sprer du hele `varsler`, setter du tre attributter som heter `host`, `toast` og `close`, og ingen av de ekte. Beholderen står da uten `role="status"`, og ingen skjermleser leser opp det som kommer i den.
