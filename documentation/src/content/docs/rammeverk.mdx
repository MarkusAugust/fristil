...
Alle web-komponentene registreres på samme måte, og hver av dem har sin egen side med et eksempel i alle fire miljøene: [Field](../components/field/), [Tabs](../components/tabs/), [Error Summary](../components/error-summary/), [Popover](../components/popover/), [Suggestion](../components/suggestion/), [Toast](../components/toast/), [Session Timeout](../components/session-timeout/) og [Connection Status](../components/connection-status/).
...
3. **Serveren skriver markupen, komponenten fester oppførsel.** Se [Markup og oppførsel](../markup-og-oppforsel/) for hvorfor, og hva det betyr i hvert av miljøene.
