...
const ledetekst = document.querySelector<HTMLLabelElement>("#kid-label")
const input = document.querySelector<HTMLInputElement>("#kid")
const hjelpetekst = document.querySelector<HTMLElement>("#kid-help")
