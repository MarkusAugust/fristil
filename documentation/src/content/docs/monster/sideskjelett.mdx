...
Nivåene skal følge hverandre uten hopp. Skal en `<h2>` se liten ut, gir du den `data-size="s"`, og lar nivået være. Hopper du til `<h4>` fordi den var liten nok, blir innholdsfortegnelsen skjermleseren bygger feil.
