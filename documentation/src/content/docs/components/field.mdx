  ...
  <TabItem label="Ren HTML">
    ...
    <script type="module">
      import { defineFsField } from
        "https://cdn.jsdelivr.net/npm/@fristil/designsystem@0.13.0/dist/components/ramme/field/fs-field.js"
...
[`fs.field`](../field/) regner ut attributtene der du rendrer, enten ved bygging i Astro, på hver render i React, eller på serveren. Nettleseren trenger ingen registrert komponent, og koblingen står ferdig i HTML-en før noe skript har kjørt:
