...
Reparasjonen gjelder én vei: har brukeren åpnet vinduet, blir det stående. Sender serveren `open`, åpnes det, for det er noe serveren faktisk sa. Skal serveren også kunne lukke det, settes `server-controlled` på `<fs-popover>`. Se [Markup og oppførsel](/markup-og-oppforsel/).
