...
<Tabs>
  ...
  <TabItem label="Ren HTML">
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fristil/designsystem@0.15.0/src/components/ramme/suggestion/suggestion.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fristil/designsystem@0.15.0/src/components/css/label/label.css">
    ```
    ...
    <script type="module">
      import { defineFsSuggestion } from
        "https://cdn.jsdelivr.net/npm/@fristil/designsystem@0.15.0/dist/components/ramme/suggestion/fs-suggestion.js"
  ...
  <TabItem label="Datastar">
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fristil/designsystem@0.15.0/src/components/css/sr-only/sr-only.css">
