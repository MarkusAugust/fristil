...
<Tabs>
  ...
  <TabItem label="Ren HTML">
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fristil/designsystem@0.15.0/src/components/ramme/dialog/dialog.css">
  ...
  <TabItem label="Datastar">
    ...
    <script type="module">
      import { defineFsDialog } from
        "https://cdn.jsdelivr.net/npm/@fristil/designsystem@0.15.0/dist/components/ramme/dialog/fs-dialog.js"
