...
De samme verdiene finnes som flagg: `--skrift`, `--skrift-kode`, `--knapp-hjorner`, `--felt-hjorner`, `--flate-hjorner`, `--knapp-ramme` og `--knapp-vekt`.
...
| `fieldRadius` | feltet og nedtrekkslista |
| `surfaceRadius` | kort, dialog, sprettoppvindu, varsel, trekkspill, feiloppsummering, filopplasting, økttidsavbrudd og forslagslista |
...
Avkryssingsboksen, radioknappen, merket, avataren og skjelettet står utenfor. Der er hjørnet ikke et stilvalg, men selve formen: en avkryssingsboks som blir rund, ser ut som en radioknapp.
