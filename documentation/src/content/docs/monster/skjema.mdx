...
| --- | --- |
| Mens brukeren skriver | Aldri. «Ugyldig e-postadresse» etter to tegn er å kjefte på noen som er halvveis. |
| Når feltet forlates | Bare hvis skjemaet er forsøkt sendt før. Da er feilen noe brukeren alt kjenner til. |
| Når skjemaet sendes | Alltid. Det er her alle feilene finnes samtidig. |

Demoen over gjør nøyaktig dette: første innsending viser alt, og etterpå oppdateres hvert felt når du forlater det.
...
Bygg lista på nytt ved hver innsending, også når de samme feilene står igjen. Da leses den opp på nytt, og brukeren vet at forsøket ble avvist.
