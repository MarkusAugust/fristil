...
| `--font-weight-semibold` | 600 | trekkspill, varsel, avatar, merke, brødsmule, kort, dialog, feiloppsummering, feltsett, ledetekst, paginering, økttidsavbrudd, tabell, faner, valggruppe |
| `--font-weight-bold` | 700 | overskrift, og stjerna som merker et påkrevd felt |
| `--semantic-line-height-default` | 1.5 | 25 stilark: knapp, felt, tekstområde, nedtrekksliste, tabell, faner, dialog og resten av kontrollene |
| `--semantic-line-height-heading` | 1.2 | overskrift |
| `--semantic-line-height-article` | 1.6 | brødtekst, liste, korttekst |
| `--semantic-line-height-compact` | 1.4 | hjelpetekst, feilmelding, hjelpeboble, etikett, korttittel, dialogtittel, feiloppsummeringens tittel, sambandslinja |
