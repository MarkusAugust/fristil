...
Samme kobling finnes som en ren funksjon, [`fs.field`](../../typesikker-bruk/#fsfield). Den regner ut attributtene der du rendrer, enten ved bygging i Astro eller på hver render i React, så nettleseren trenger ingen registrert komponent:
