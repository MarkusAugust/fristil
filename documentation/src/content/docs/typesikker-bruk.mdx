...
Knappen får primærstilen. Ingen feilmelding, bare en variant som stille aldri ble brukt. Derfor finnes `fs`. Skriver du HTML uten TypeScript, tar [utvidelsen for VS Code](../editoren/) den samme feilen.
