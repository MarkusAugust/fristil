...
Pakken følger [semantisk versjonering](https://semver.org/lang/no/). Det offentlige API-et er større enn funksjonene: klassenavnene, `data-*`-attributtene, `part`-navnene, tokennavnene, `--fs-*`-variablene og oppføringene i `exports` er alle noe du kan bygge på, og de endres ikke uten en ny hovedversjon.
...
- [Editoren](../editoren/): fullføring og feilmeldinger i VS Code og JetBrains, også uten TypeScript
