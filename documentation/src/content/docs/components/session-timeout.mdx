...
<Tabs>
  ...
  <TabItem label="Ren HTML">
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fristil/designsystem@0.15.0/src/components/frittstaende/session-timeout/session-timeout.css">
    ```
    ...
    <script type="module">
      import { defineFsSessionTimeout } from
        "https://cdn.jsdelivr.net/npm/@fristil/designsystem@0.15.0/dist/components/frittstaende/session-timeout/fs-session-timeout.js"
  ...
  <TabItem label="React">
    ```ts
    // src/fristil.d.ts, gir <fs-session-timeout> typer i JSX
