...
Derfor setter byggeren `data-ignore-morph`. Det ber Datastar la innholdet være, slik at en patch ikke river dialogen bort mens den står åpen. Se [Markup og oppførsel](/markup-og-oppforsel/) for hele regelen.
