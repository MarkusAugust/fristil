...
<Preview
  ...
  ekstraCss={`
    .prove { margin: 0; }
    .prove-xxs { font-size: var(--font-size-xxs); }
    .prove-xs { font-size: var(--font-size-xs); }
    .prove-s { font-size: var(--font-size-s); }
    .prove-m { font-size: var(--font-size-m); }
    .prove-l { font-size: var(--font-size-l); }
    .prove-xl { font-size: var(--font-size-xl); }
    .prove-xxl { font-size: var(--font-size-xxl); }
    .prove-mega { font-size: var(--font-size-mega); }
  `}
>
  <p class="prove prove-xxs">xxs, 0.625rem</p>
  <p class="prove prove-xs">xs, 0.75rem</p>
  <p class="prove prove-s">s, 0.875rem</p>
  <p class="prove prove-m">m, 1rem, brødtekst</p>
  <p class="prove prove-l">l, 1.125rem</p>
  <p class="prove prove-xl">xl, 1.375rem</p>
  <p class="prove prove-xxl">xxl, 1.875rem</p>
  <p class="prove prove-mega">mega, 2.625rem</p>
</Preview>
...
| --- | --- | --- |
| `--font-weight-regular` | 400 | ledetekst uten vekt, feltsettets valgfrie felt |
| `--font-weight-medium` | 500 | knapp, feilmelding |
| `--font-weight-semibold` | 600 | ledetekst, korttittel, varsel, trekkspill, tabelloverskrift, fane, merke, avatar, brødsmule, paginering, valggruppe, dialogtittel, feiloppsummering, økttidsavbrudd |
| `--font-weight-bold` | 700 | overskrift, ledetekst i stor utgave, feltsettets tittel |
| `--semantic-line-height-default` | 1.5 | knapp, felt, tekstområde, nedtrekksliste, tabell, fane, dialog, sprettoppvindu, varsel, trekkspill, forslagsliste, melding og en rekke til |
| `--semantic-line-height-heading` | 1.2 | overskrift |
| `--semantic-line-height-article` | 1.6 | brødtekst, liste, korttekst |
...
Fire linjeavstander står fortsatt som tall i stilarkene: `1`, `1.3`, `1.4` og `1.55`. De er finjustering i én komponent, ikke en rytme noen vil endre på tvers, og et token for hver av dem ville vært en oppfinnelse.
