...
### Merkingen og det enkleste feltet

Det enkleste `<fs-field>` er tre linjer, og komponenten gjør resten: klikk på teksten flytter fokus til feltet, og skjermleseren leser riktig ledetekst.
...
`required-marker` velger hvordan et påkrevd felt merkes, og `optional` snur det om: merk det valgfrie framfor det påkrevde, når nesten alt i skjemaet må fylles ut.
